...
public class ScrollingMap extends World
{
    ...
    {    
        ...
        setPaintOrder(ItemInventory.class, InfoTab.class, ProfileWindow.class, MoveCount.class, Button.class, ValueBox.class, HUD.class, Inventory.class, FloorCount.class, ExperienceBar.class, FadingWord.class, AttackEffect.class, Target.class, Chest.class, Player.class, Items.class, Mobs.class, Tile.class);
